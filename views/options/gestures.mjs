...
function onGesturePopupClose () {
  ...
  // reset gesture popup
  gesturePopupHeading.textContent = chrome.i18n.getMessage('gesturePopupTitleNewGesture');
...
function openGesturePopup (gesture = null) {
  ...
  const gesturePopupPatternContainer = document.getElementById("gesturePopupPatternContainer");
        ...
        gesturePopupPatternContainer.dataset.gestureRecordingHint = chrome.i18n.getMessage(
  ...
  if (gesture) {
    gesturePopupHeading.textContent = chrome.i18n.getMessage('gesturePopupTitleEditGesture');
